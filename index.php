...
<body>
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		<div class="container">
			<a class="navbar-brand" href="#">WEB CRUD MySQLi</a>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item">
						<a class="nav-link" href="tambah biodata diri.php">Tambah Biodata Diri</a>
					</li>
				</ul>
			</div>
		</div>
	...
	<div class="container" style="margin-top:20px">
		<h2>Daftar Biodata Diri</h2>
		<hr>
		<table class="table table-striped table-hover table-sm table-bordered">
			<thead class="thead-dark">
	<title>Gambar HTML</title>
    <img src="upload/foto.png" width="80px" height="100px"> 
    <hr>
			...
			<tbody>
				<?php
				//query ke database SELECT tabel biodata diri
